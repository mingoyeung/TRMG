...
if __name__ == "__main__":
    ...
    # 读取数据
    print("加载数据...")
    df = pd.read_csv('../4.1-4.3/trmg/imfreconstruction_TenneT.csv')
    a = np.array(df.values[:, 0])#0-sub1,1-sub2,2-sub3,3-sub4,4-sub5
    ...
    #Without optuna, using hyperparamters directly
    RESULTS_JSON = 'trmg1_single_hidden_results.json'#1,2,3,4,5
    ...
    pred_df.to_excel('trmg1l_single1.xlsx', index=True)#Sub1-5 prediction results
