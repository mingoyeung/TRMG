...
if __name__ == "__main__":
    ...
    #  ═══════════════════════Optuna searching (Option C),uncomment to use════════════════════════════════
        ...
        save_results_to_json(
            ...
            filename='trmg1_results.json') #Obtain:sub1:trmg1_results;sub2:trmg2_results;sub3:trmg3_results;sub4:trmg4_results;sub5:trmg5_results
    ...
    pred_df.to_excel('trmg1.xlsx', index=False)#Save:sub1:trmg1;sub2:trmg2;sub3:trmg3;sub4:trmg4;sub5:trmg5
