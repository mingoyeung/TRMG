...
if __name__ == "__main__":
    ...
    if MODE == 'B':
        RESULTS_JSON = 'ermg1_results.json'#Choose:esub1:ermg1_results;esub2:ermg2_results;esub3:ermg3_results;sub4:ermg4_results;esub5:ermg5_results
    ...
    #  =======================Optuna searching (Option C),uncomment to use================================
        ...
        save_results_to_json(
            ...
            filename='ermg1_results.json')#Obtain:esub1:ermg1_results;esub2:ermg2_results;esub3:ermg3_results;sub4:ermg4_results;esub5:ermg5_results
    ...
    pred_df.to_excel('ermg1.xlsx', index=False)#Save:esub1:ermg1;esub2:ermg2;esub3:ermg3;sub4:ermg4;esub5:ermg5