...
def objective(trial, x_train, y_train, x_val, y_val, taus, scaler,
    ...
    n_hidden2 = trial.suggest_int('n_hidden2', 1, 10)#敏感性分析减少该层
...
if __name__ == "__main__":
    ...
    RESULTS_JSON = 'trmg1_results.json'#1,2,3,4,5
    ...
    pred_df.to_excel('trmgf1.xlsx', index=True)#sub1-5 prediction results
