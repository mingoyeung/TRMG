...
class Mcqrnn(tf.keras.Model):
    def __init__(self, n_hidden, penalty=0, activation=tf.nn.sigmoid, **kwargs):
        super().__init__(**kwargs)
...
def train_model(x_train, y_train, taus, n_hidden, penalty,
...
def objective(trial, x_train, y_train, x_val, y_val, taus, scaler,
    ...
    n_hidden = trial.suggest_int('n_hidden', 1, 10) #no hidden_2
    penalty = trial.suggest_float('penalty', 1e-4, 1e-1)

    model, train_loss = train_model(
        x_train, y_train, taus, n_hidden, penalty,
...
if __name__ == "__main__":
    ...
    if MODE == 'B':
        RESULTS_JSON = 'trmg1_single_hidden_results.json'
        #Change:sub1:trmg1_single_hidden_results;sub2:trmg2_single_hidden_results;
        #sub3:trmg3_single_hidden_results;sub4:trmg4_single_hidden_results;sub5:trmg5_single_hidden_results
    ...
    #  =======================Optuna searching (Option C),uncomment to use================================
        ...
        save_results_to_json(
            ...
            filename='trmg1_single_hidden_results.json')
        #Obtain:sub1:trmg1_single_hidden_results;sub2:trmg2_single_hidden_results;
        #sub3:trmg3_single_hidden_results;sub4:trmg4_single_hidden_results;sub5:trmg5_single_hidden_results
    ...
    pred_df.to_excel('trmg1_single1.xlsx', index=False)#Save:sub1:trmg1_single1;sub2:trmg1_single2;sub3:trmg1_single3;sub4:trmg1_single4;sub5:trmg1_single5
