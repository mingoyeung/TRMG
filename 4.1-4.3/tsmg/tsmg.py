...
if __name__ == "__main__":
    ...
    a = np.array(df.values[:, 3])##0-sub1; 1-sub2;2-sub3;3-sub4
    ...
    RESULTS_JSON = 'tsmg1_results.json'#1,2,3,4
    ...
    pred_df.to_excel('tsmg1.xlsx', index=True)#Sesub1-4 prediction results
