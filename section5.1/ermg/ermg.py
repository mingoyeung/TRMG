...
def evaluate_model_denormalized(model, x_val, y_val, taus, scaler):
    ...
    # Compute overall loss (original scale)
...
def optuna_search_hyperparameters(x_train, y_train, x_val, y_val, taus, scaler,
    ...
    print(f"  Validation loss (original scale): {study.best_value:.4f}")
...
def split_data(data, horizon, window):
    ...
    for i in range(n - window - horizon):
        ...
        X[i, :] = data[start:end, 0]  # Choose 0-esub1; 1-esub2;2-esub3;3-esub4;4-esub5
...
if __name__ == "__main__":
    ...
    print("Loading data...")
    df = pd.read_excel('emdfujian.xlsx')
    ...
    if MODE == 'B':
        RESULTS_JSON = 'ermgf1_results.json'#Change:esub1:ermgf1_results;esub2:ermgf2_results;esub3:ermgf3_results;sub4:ermgf4_results;esub5:ermgf5_results
    ...
    #  ═══════════════════════Optuna searching (Option C),uncomment to use════════════════════════════════
        ...
        save_results_to_json(
            ...
            filename='ermgf1_results.json')
        # Obtain:esub1:ermgf1_results;esub2:ermgf2_results;esub3:ermgf3_results;sub4:ermgf4_results;esub5:ermgf5_results
    ...
    pred_df.to_excel('ermgf1.xlsx', index=False)#Save:esub1:ermgf1;esub2:ermgf2;esub3:ermgf3;sub4:ermgf4;esub5:ermgf5
