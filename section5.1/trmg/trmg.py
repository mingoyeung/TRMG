...
if __name__ == "__main__":
    ...
    if MODE == 'B':
        RESULTS_JSON = 'trmg1_results.json' #Change:sub1:trmg1_results;sub2:trmg2_results;sub3:trmg3_results;sub4:trmg4_results;sub5:trmg5_results
    ...
    #  =======================Optuna searching (Option C),uncomment to use================================
        ...
        save_results_to_json(
            ...
            filename='trmg1_results.json')
        # Obtain:sub1:trmg1_results;sub2:trmg2_results;sub3:trmg3_results;sub4:trmg4_results;sub5:trmg5_results
    ...
    pred_df.to_excel('trmgf1.xlsx', index=False)#Save:sub1:trmgf1;sub2:trmgf2;sub3:trmgf3;sub4:trmgf4;sub5:trmgf5
