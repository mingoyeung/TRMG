...
def split_data(data, horizon, window):
    ...
    for i in range(n - window - horizon):
        ...
        X[i, :] = data[start:end, 0]  #Choose: 0-sesub1; 1-sesub2;2-sesub3
        Y[i] = data[end + horizon - 1, 0]
        EX[i, :] = data[end + horizon - 1, 3:4]
    return X, Y, EX
...
if __name__ == "__main__":
    ...
    if MODE == 'B':
        RESULTS_JSON = 'tsmgf1_results.json' #Change:sesub1:tsmgf1_results;sesub2:tsmgf2_results;sesub3:tsmgf3_results
    ...
    #  =======================Optuna searching (Option C),uncomment to use================================
        ...
        save_results_to_json(
            ...
            filename='tsmgf1_results.json')
        # Obtain:sesub1:tsmgf1_results;sesub2:tsmgf2_results;sesub3:tsmgf3_results
    ...
    pred_df.to_excel('tsmgf1.xlsx', index=False)#Save: sesub1:tsmgf1;sesub2:tsmgf2;sesub3:tsmgf3
